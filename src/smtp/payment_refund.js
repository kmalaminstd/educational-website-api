...
const mailTemplate = require('../email_templates/payment_refund')
...
const paymentRefundMail = async (user_id) => {
  try{
    ...
    if(data.status){
      ...
      await emailTransport.sendMail({
        ...
        html: mailTemplate(result.name, result.title)
      })
...
module.exports = paymentRefundMail